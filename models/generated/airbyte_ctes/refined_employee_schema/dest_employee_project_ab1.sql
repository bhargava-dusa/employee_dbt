...
-- depends_on: {{ source('refined_employee_schema', '_airbyte_raw_dest_employee_project') }}
select
...
from {{ source('refined_employee_schema', '_airbyte_raw_dest_employee_project') }} as table_alias
